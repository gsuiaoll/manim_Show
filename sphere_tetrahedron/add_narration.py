"""
为 sphere_tetrahedron_raw.mp4 添加 TTS 旁白 + 字幕 + BGM
"""
import asyncio
import subprocess
...
VIDEO = Path("D:/code/jianjicode-5/jianjicode/python/manim_templates/output/sphere_tetrahedron_raw.mp4")
OUTPUT = VIDEO.parent / "sphere_tetrahedron_final.mp4"
...
# 视觉节奏: title(0-2) → sphere+tet(2-7) → question(7-11) → MC samples(12-17)
# → cognitive(18-21) → 3D→2D morph(22-27) → 2D setup(27-31)
# → fix vars(32-35) → P3 move+arc(35-43) → 2D answer(43-46)
# → back 3D+cliff(47-55)
...
async def main():
    temp_dir = VIDEO.parent / "tts_temp_tetrahedron"
    ...
    with open(ass, "w", encoding="utf-8") as f:
        ...
        f.write("Style: Default,Noto Sans SC,64,&H00FFFFFF,&H000000FF,"
